...
python main_project.py - use to run trokenize the word train model to understand, then validate word that are correct and test to make it generate valid khmer text sentences
